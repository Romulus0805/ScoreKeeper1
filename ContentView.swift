    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            HStack {
                ...
                case .playing:
                    if (scoreboard.round <= numberOfRounds){
                        Button("Next round", systemImage: "arrow.right") {
                            scoreboard.round += 1
                            scoreboard.addRoundScore()
                            scoreboard.resetGameScores(to: startingPoints)
                        }
                    }
                    
                    else {
                        Button("Game Over", systemImage: "xmark.circle") {
